...
public class boardInsertAction2 extends AbstractAction {
    ...
    public void execute(HttpServletRequest req, HttpServletResponse res) throws Exception {
        ...
        if (!req.getMethod().equalsIgnoreCase("post")) {
            ...
            this.setViewPage("boardInsert2.do");
            return;
        }
        ...
        int cg_num_i = Integer.parseInt(cg_num);
        ...
        // 후처리
        BoardVO board = new BoardVO(0, btitle, bcontent, 0, null, bupload1, bupload2, bupload3, 0, 0, cg_num_i);

        BoardDAOMyBatis dao = new BoardDAOMyBatis();
        int n = dao.insertBoard(board);

        System.out.println("cgnum = " + cg_num_i);
        System.out.println("board = " + board);

        String str = (n > 0) ? "글쓰기 성공" : "글쓰기 실패";
        String loc = (n > 0) ? "boardList2.do" : "javascript:history.back()";
